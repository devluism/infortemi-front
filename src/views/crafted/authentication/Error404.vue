    ...
    <div class="d-flex flex-column flex-center text-center p-10">
      ...
      <div class="card card-flush w-lg-650px py-5">
        <div class="card-body py-15 py-lg-20">
          ...
          <p class="text-center">If you keep getting this error, please contact our support team.</p>
          <!--end::Text-->
          <!--begin::Illustration-->
          <div class="mb-3">
            <img
              :src="getAssetPath('media/auth/404-error.png')"
              class="mw-60 mh-200px theme-light-show"
              alt=""
            />
            <img
              :src="getAssetPath('media/auth/404-error-dark.png')"
              class="mw-50 mh-200px theme-dark-show"
              alt=""
            />
          </div>
          <!--end::Illustration-->
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      storeBody.addBodyAttribute({
        qualifiedName: "style",
        value: `background: linear-gradient(110deg, #04E886 -10%, #078AF0)`,
