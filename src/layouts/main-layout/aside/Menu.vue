<template>
  <!--begin::Menu-->
  <div
    class="hover-scroll-overlay-y my-2 my-lg-5 pe-lg-n1 bg-none"
      ...
      <template v-for="(item, i) in MainMenuConfig" :key="i">
        <template v-if="!item.pages">
          <template v-if="item.heading">
            ...
            <div v-if="item.route && (user.admin === item.admin || item.admin === 'all')" 
              class="menu-item py-3"
              :class="{ 'show here': currentActive(item.route) }"
            >
              <router-link
                v-if="item.route && item.route != '/sign-out'"
              ...
              >
                ...
                <span class="menu-title text-white text-center text-nowrap">{{ translate(item.heading) }}</span>
              </router-link>
        ...
        <template v-if="item.pages">
          <div
            ...
            class="menu-item py-3 text-white"
          >
            <span class="menu-link menu-center">
              ...
              <span class="menu-title text-white text-center text-nowrap">{{ translate(item.sectionTitle) }}</span>
            </span>
            <div
...
.menu-item.show.menu-dropdown > .menu-link > .menu-title,
.menu-item.show.menu-dropdown > .menu-link > .menu-icon i {
