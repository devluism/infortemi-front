    ...
    >
      ...
      >
        <template v-for="(item, i) in MainMenuConfig" :key="i">
          <div v-if="item.heading && item.admin" class="menu-item pt-5">
          ...
          <template v-for="(menuItem, j) in item.pages" :key="j">
            <template v-if="menuItem.heading && (user.admin === menuItem.admin || menuItem.admin === 'all')">
              <div class="menu-item">
                <router-link
                  v-if="menuItem.route"
                  class="menu-link"
            ...
            <div
              v-if="menuItem.sectionTitle && menuItem.route && menuItem.admin"
            ...
            >
              ...
              >
                <template v-for="(item2, k) in menuItem.sub" :key="k">
                  <div v-if="item2.heading && item2.admin" class="menu-item">
                    <router-link
                      v-if="item2.route"
                      class="menu-link"
                      active-class="active"
                  ...
                  <div
                    v-if="item2.sectionTitle && item2.route && item2.admin"
                  ...
                  >
                    ...
                    >
                      <template v-for="(item3, k) in item2.sub" :key="k">
                        <div v-if="item3.heading && item3.admin" class="menu-item">
                          <router-link
                            v-if="item3.route"
                            class="menu-link"
                            active-class="active"
